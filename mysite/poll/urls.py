...
urlpatterns = [
    ...
    path('poll/owner/<int:pk>/', OwnerDetailView.as_view(), name='owner-detail'),
    path('poll/owner/<int:pk>/update/', OwnerUpdateView.as_view(), name='owner-update'),  # обновление
    ...
    path('poll/group/', GroupsListView.as_view(), name='groups-list'),  # new
